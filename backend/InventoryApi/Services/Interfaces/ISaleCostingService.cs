...
{
    Task CostSaleAsync(NayaxSales sale, bool force = false, CancellationToken cancellationToken = default);
    Task<int> CostPendingSalesAsync(long? productId = null, CancellationToken cancellationToken = default);
    ...
    Task<NayaxCostBackfillResult> BackfillHistoricalCostsFromNayaxAsync(
        bool dryRun = true,
        bool force = false,
        DateTime? from = null,
        DateTime? to = null,
